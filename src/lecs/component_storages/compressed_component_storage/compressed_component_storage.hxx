...
namespace lecs::detail {
    ...
    public:
        ...
        using EntityToComponent = std::conditional_t<ComponentStorageInfo<ComponentType>::USE_MAP_VERSION, CCS_EntityToComponent_Map, CCS_EntityToComponent_InlineType>;
    ...
    public:
        ...
        ComponentType& add_component_to_entity(EntityId entity, Args&&... args) {
            ...
            if (page->can_add_component() == false) free_pages_.erase(indexOfFreePage);
