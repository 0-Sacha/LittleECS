...
namespace lecs
{
    ...
    typename detail::ComponentStorageInfo<ComponentType>::StorageType* Registry::GetComponentStorageOrCreateIt()
    {
        ...
        else
        {
            std::unique_ptr<detail::IComponentStorage>& componentStorageRef =
                componentid_to_component_data_[componentId].component_storage = std::make_unique<typename detail::ComponentStorageInfo<ComponentType>::StorageType>();
    ...
    bool Registry::has(EntityId entity)
    {
        ...
        if (componentStoragefound == componentid_to_component_data_.end())
            return false;

        detail::IComponentStorage* componentStorageBasic = componentStoragefound->second.component_storage.get();
        typename detail::ComponentStorageInfo<ComponentType>::StorageType* component_storage = reinterpret_cast<typename detail::ComponentStorageInfo<ComponentType>::StorageType*>(componentStorageBasic);
