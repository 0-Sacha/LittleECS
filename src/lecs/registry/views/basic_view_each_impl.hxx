...
namespace lecs {
    ...
    decltype(auto) BasicConstView<ViewComponentTypes...>::each_entities_with_all() const {
        if constexpr (sizeof...(ComponentTypesEach) == 0)
            ...
            return detail::Iterable(detail::ViewEntitiesIterator<M_Type, decltype(ranged_component.begin()), decltype(ranged_component.end()), ComponentTypesEach...>(
                                        this, ranged_component.begin(), ranged_component.end()),
                                    detail::IterableEnd());
        }
    }
    ...
    decltype(auto) BasicConstView<ViewComponentTypes...>::each_components() const {
        ...
        auto entities         = detail::ViewEntitiesIterator<const M_Type, decltype(ranged_component.begin()), decltype(ranged_component.end()), ComponentTypesEach...>(
            this, ranged_component.begin(), ranged_component.end());

        return detail::Iterable(detail::ViewComponentsIterator<const M_Type, decltype(entities), detail::IterableEnd, false, RangeComponent, ComponentTypesEach...>(
                                    this, entities, detail::IterableEnd()),
                                detail::IterableEnd());
    }
}  // namespace lecs
...
namespace lecs {
    ...
    decltype(auto) BasicView<ViewComponentTypes...>::each_components() {
        ...
        auto entities         = detail::ViewEntitiesIterator<M_Type, decltype(ranged_component.begin()), decltype(ranged_component.end()), ComponentTypesEach...>(
            this, ranged_component.begin(), ranged_component.end());
