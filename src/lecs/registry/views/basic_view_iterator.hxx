...
namespace lecs::detail {
    ...
    public:
        ViewEntitiesIterator(const BasicViewLinked* basicViewLinked, SubEntitiesIterator subEntitiesIterator, SubEntitiesIteratorLast subEntitiesIteratorLast)
            : basic_view_linked_(basicViewLinked), sub_entities_iterator_(subEntitiesIterator), sub_entities_iterator_last_(subEntitiesIteratorLast) {}
    ...
    public:
        ...
        ViewEntitiesIterator& operator++() {
            ...
            do {
                ...
                if (sub_entities_iterator_ == sub_entities_iterator_last_) break;
        ...
        ViewEntitiesIterator operator++(int) {
            ViewEntitiesIterator res(basic_view_linked_, sub_entities_iterator_, sub_entities_iterator_last_);
            ++(*this);
            return res;
        }
...
#ifdef LECS_DEBUG
            bool complex_result = basic_view_linked_ != nullptr && basic_view_linked_ == rhs.basic_view_linked_ && sub_entities_iterator_ == rhs.sub_entities_iterator_ &&
    ...
    public:
        ...
        using value_type = std::conditional_t<INCLUDE_ENTITY, std::tuple<EntityId, IteratorComponentTypes&...>, std::tuple<IteratorComponentTypes&...>>;
    ...
    public:
        ViewComponentsIterator(BasicViewLinked* basicViewLinked, SubViewEntitiesIterator subViewEntitiesIterator, SubViewEntitiesIteratorLast subViewEntitiesIteratorLast)
            : basic_view_linked_(basicViewLinked), sub_view_entities_iterator_(subViewEntitiesIterator), sub_view_entities_iterator_last_(subViewEntitiesIteratorLast) {}
    ...
    public:
        ...
        ViewComponentsIterator& operator++() {
            ...
            if (sub_view_entities_iterator_ == sub_view_entities_iterator_last_) basic_view_linked_ = nullptr;
            return *this;
        }
...
#ifdef LECS_DEBUG
            bool complex_result = basic_view_linked_ != nullptr && basic_view_linked_ == rhs.basic_view_linked_ && sub_view_entities_iterator_ == rhs.sub_view_entities_iterator_ &&
