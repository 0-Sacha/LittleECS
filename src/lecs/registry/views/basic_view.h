...
namespace lecs
{
    ...
    public:
        BasicConstView(const Registry& linked_registry)
            : linked_registry_(linked_registry)
            , link_to_component_container_{ nullptr }
        {
            refresh();
        }
    ...
    public:
        BasicView(Registry& linked_registry)
            : Base(linked_registry)
        {}
