...
#define BasicWorkflow(Postfix_ComponentToUse) PCT_TEST_FUNC(BASIC_WORKFLOW, BASIC_WORK_FLOW_TEST##Postfix_ComponentToUse)                                                                                                    \
            {                                                                                                                                                                                                           \
                ...
                PCT_ASSERT(registry.Has<BasicIntComponent##Postfix_ComponentToUse>(entity3) == false);                                                                                                                                           \
                                                                                                                                                                                                                       \
                registry.ForEachComponents<BasicIntComponent##Postfix_ComponentToUse, BasicFloatComponent>([](BasicIntComponent##Postfix_ComponentToUse& k, BasicFloatComponent& v)                                                                                       \
                {                                                                                                                                                                                                       \
                    k = 325ull;                                                                                                                                                                                           \
                    v = 22.0f;                                                                                                                                                                                           \
                });                                                                                                                                                                                                       \
                                                                                                                                                                                                                       \
                constRegistry.ForEachComponents<BasicIntComponent##Postfix_ComponentToUse, BasicFloatComponent>([&link](const BasicIntComponent##Postfix_ComponentToUse& k, const BasicFloatComponent& v)                                                               \
                {                                                                                                                                                                                                       \
                    PCT_EQ(k.Value, 325ull);                                                                                                                                                                           \
                    PCT_EQ(v.Value, 22.0f);                                                                                                                                                                               \
                });                                                                                                                                                                                                       \
                                                                                                                                                                                                                       \
                registry.ForEachComponents<BasicIntComponent##Postfix_ComponentToUse>([](BasicIntComponent##Postfix_ComponentToUse& k)                                                                                                                                   \
                {                                                                                                                                                                                                       \
                    k = 85ull;                                                                                                                                                                                           \
                });                                                                                                                                                                                                       \
                                                                                                                                                                                                                       \
                constRegistry.ForEachComponents<BasicIntComponent##Postfix_ComponentToUse>([&link](const BasicIntComponent##Postfix_ComponentToUse& k)                                                                                                                   \
                {                                                                                                                                                                                                       \
                ...
                PCT_ASSERT(registry.Has<BasicFloatComponent>(entity2) == false);                                                                                                                                       \
                                                                                                                                                                                                                       \
                registry.ForEachUniqueComponent<BasicIntComponent##Postfix_ComponentToUse>([](LECS::EntityId entity, BasicIntComponent##Postfix_ComponentToUse& k)                                                                                                       \
                {                                                                                                                                                                                                       \
                ...
                PCT_EQ(entityCount, 2);                                                                                                                                                                                   \
                                                                                                                                                                                                                       \
                entityCount = 0;                                                                                                                                                                                       \
                view.ForEachComponents<BasicIntComponent##Postfix_ComponentToUse, BasicFloatComponent>([&entityCount, &link, &registry](LECS::EntityId entity, BasicIntComponent##Postfix_ComponentToUse& k, BasicFloatComponent& v)                                   \
                {                                                                                                                                                                                                       \
                    PCT_ASSERT(registry.Has<BasicIntComponent##Postfix_ComponentToUse>(entity));                                                                                                                                               \
                ...
                PCT_EQ(entityCount, 1);                                                                                                                                                                                   \
                                                                                                                                                                                                                       \
                entityCount = 0;                                                                                                                                                                                       \
                view.ForEachComponents<BasicIntComponent##Postfix_ComponentToUse, BasicFloatComponent>([&entityCount](BasicIntComponent##Postfix_ComponentToUse& k, BasicFloatComponent& v)                                                                               \
                {                                                                                                                                                                                                       \
                    ++entityCount;                                                                                                                                                                                       \
                });                                                                                                                                                                                                       \
                PCT_EQ(entityCount, 1);                                                                                                                                                                                   \
